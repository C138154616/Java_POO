...
CREATE TABLE `vaccin` (
  ...
  `TypeVaccin` varchar(45) NOT NULL,
...
INSERT INTO `vaccin` VALUES (1,'AstraZeneca','kzajhdkajzdsa'),(6,'Senofarme','jgzdjhgdjhzgd zjhdgzajgh'),(7,'JONSON','QSDFGHJKJGFDSZERTYUE');
